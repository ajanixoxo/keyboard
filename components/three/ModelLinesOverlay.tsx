...
interface ModelLinesOverlayProps {
  keysRef: React.RefObject<THREE.Group>;
  innerRef: React.RefObject<THREE.Group>;
  pcbBaseRef: React.RefObject<THREE.Group>;
}

function ModelLinesContent({ keysRef, innerRef, pcbBaseRef }: ModelLinesOverlayProps) {
...
export function ModelLinesOverlay(props: ModelLinesOverlayProps) {
  return <ModelLinesContent {...props} />;
}
